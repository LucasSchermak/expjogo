...
public class Game 
{
    ...
    public void createRooms()
    {
        ...
        quarto = new Room("no meu quarto", "aqui ficam meus brinquedos e minha cama. Meu irmão mais velho, Jonas, também dorme aqui, mas ele é chato. Sorte que ele está dormindo agora");
        ...
        c1.setPorta("quartodospais", quartoPais, true);
        ...
        sala.setPorta("porta", rua1, true);
        garagem.setExit("porta", c2);
        garagem.setPorta("portao", rua1, true);
