...
public class Game 
{
	...
	ladrao1.setExit("checar", ladrao2);
        ladrao2.setExit("esconder", ladrao3);
        ladrao3.setExit("portal", inicio);
        
        sala.setItem("chave","- do quarto da mamãe");
        quartoPais.setItem("controle","- da porta da garagem");
